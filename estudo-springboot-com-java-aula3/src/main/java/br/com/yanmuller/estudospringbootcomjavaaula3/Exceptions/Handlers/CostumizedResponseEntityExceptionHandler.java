package br.com.yanmuller.estudospringbootcomjavaaula3.Exceptions.Handlers;

import br.com.yanmuller.estudospringbootcomjavaaula3.Exceptions.ExceptionResponse;
...
public class CostumizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(ResourseNotFoundExceptions.class)//tratar exceçoes mais genericas
